 ...
 */
class RteBackendController extends \TYPO3\CMS\Rtehtmlarea\RteHtmlAreaBase {
    ...
    public function drawRTE(&$parentObject, $table, $field, $row, $PA, $specConf, $thisConfig, $RTEtypeVal, $RTErelPath, $thePidValue) {
        ...
        // RTE configuration
        $pageTSConfig = BackendUtility::getPagesTSconfig($this->TCEform->storagePid);
...
//         Register RTE in JS
        ...
        $item = $this->triggerField($PA['itemFormElName']) . '
			<div id="pleasewait' . $textAreaId . '" class="pleasewait" style="display: block;" >' . 'Please wait' . '</div>
